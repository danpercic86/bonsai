...
If you are **resuming** an in-progress build: first read `TODO.md` in the repo root and the last
commit / git log to find the current milestone, tell me where things stand, then continue the loop
from there.
