...
/// Process spawn/drain/timeout helpers, split out of this file; re-used by
/// `run_claude` and `check_availability` via `pub(super)`.
mod process;
use process::{kill_child_tree, resolve_bin, run_process};
